        ...
        if user_message:
            ...
            if user_message.lower().strip() in greetings:
                ...
                try:
                    ...
                    # Prepare contents for the legacy SDK
                    contents = []
                        ...
                        try:
                            ...
                            if data.get('action') == 'predict':
                                ...
                                if error:
                                    ...
                                    contents.append({'role': 'model', 'parts': [bot_reply]})
                                    contents.append({'role': 'user', 'parts': [remedy_prompt]})
                                    
                                    remedy_response = model.generate_content(contents)
